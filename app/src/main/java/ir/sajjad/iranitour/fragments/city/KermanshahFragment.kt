...
import ir.sajjad.iranitour.databinding.FragmentKermanshahBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent


class KermanshahFragment : Fragment(), ItemCityEvent {
    lateinit var binding: FragmentKermanshahBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentKermanshahBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.eslamabad_gharb),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.paveh),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.salas_babajani),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.javanrud),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.dalahu),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.ravansar),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.sarpol_zahab),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.sonqor),
                "",
                "",
                false
            ),
            ItemPostCity(
                9,
                resources.getString(R.string.sahneh),
                "",
                "",
                false
            ),
            ItemPostCity(
                10,
                resources.getString(R.string.gasr_shirin),
                "",
                "",
                false
            ),
            ...
            ItemPostCity(
                11,
                resources.getString(R.string.kermanshah),
                "",
                "",
                false
            ),
            ItemPostCity(
                12,
                resources.getString(R.string.kangavar),
                "",
                "",
                false
            ),
            ItemPostCity(
                13,
                resources.getString(R.string.gilanegharb),
                "",
                "",
                false
            ),
            ItemPostCity(
                14,
                resources.getString(R.string.harsin),
                "",
                "",
                false
            )
        ...
        binding.recyclerKermanshah.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerKermanshah.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerKermanshah.layoutAnimation = controller
    }
