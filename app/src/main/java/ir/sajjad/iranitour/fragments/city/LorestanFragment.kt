...
import ir.sajjad.iranitour.databinding.FragmentLorestanBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent

class LorestanFragment : Fragment(), ItemCityEvent {
    lateinit var binding: FragmentLorestanBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentLorestanBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.azna),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.aligudarz),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.borujerd),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.poldokhtar),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.chegani),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.khorram_abad),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.delfan),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.dorud),
                "",
                "",
                false
            ),
            ItemPostCity(
                9,
                resources.getString(R.string.rumeshkan),
                "",
                "",
                false
            ),
            ItemPostCity(
                10,
                resources.getString(R.string.selseleh),
                "",
                "",
                false
            ),
            ItemPostCity(
                11,
                resources.getString(R.string.kuhdasht),
                "",
                "",
                false
            )
        ...
        binding.recyclerLorestan.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerLorestan.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerLorestan.layoutAnimation = controller
    }
