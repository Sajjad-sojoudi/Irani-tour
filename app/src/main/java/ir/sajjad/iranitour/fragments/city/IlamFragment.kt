...
import ir.sajjad.iranitour.databinding.FragmentIlamBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent

class IlamFragment : Fragment(), ItemCityEvent {
    lateinit var binding: FragmentIlamBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentIlamBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.abdanan),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.ilam),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.eyvan),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.badreh),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.chardavol),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.chovar),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.darreh_shahr),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.dehloran),
                "",
                "",
                false
            ),
            ItemPostCity(
                9,
                resources.getString(R.string.sirvan),
                "",
                "",
                false
            ),
            ItemPostCity(
                10,
                resources.getString(R.string.malekshahi),
                "",
                "",
                false
            ),
            ItemPostCity(
                11,
                resources.getString(R.string.mehran),
                "",
                "",
                false
            ),
            ItemPostCity(
                12,
                resources.getString(R.string.holeylan),
                "",
                "",
                false
            )
        ...
        binding.recyclerIlam.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerIlam.setHasFixedSize(true)
        binding.recyclerIlam.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerIlam.layoutAnimation = controller
