...
import ir.sajjad.iranitour.databinding.FragmentQazvinBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent

class QazvinFragment : Fragment(), ItemCityEvent {
    lateinit var binding: FragmentQazvinBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentQazvinBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.abeyk),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.avaj),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.alborz),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.bueenzahra),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.takestan),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.qazvin),
                "",
                "",
                false
            )
        ...
        binding.recyclerQazvin.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerQazvin.setHasFixedSize(true)
        binding.recyclerQazvin.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerQazvin.layoutAnimation = controller
