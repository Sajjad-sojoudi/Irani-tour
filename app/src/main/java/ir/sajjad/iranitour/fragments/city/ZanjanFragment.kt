...
import ir.sajjad.iranitour.databinding.FragmentZanjanBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent

class ZanjanFragment : Fragment(), ItemCityEvent {
    lateinit var binding: FragmentZanjanBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentZanjanBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.abhar),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.ijrud),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.khodabandeh),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.khorramdarreh),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.zanjan),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.soltaniyeh),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.tarom),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.mahneshan),
                "",
                "",
                false
            )
        ...
        binding.recyclerZanjan.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerZanjan.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerZanjan.layoutAnimation = controller
    }
