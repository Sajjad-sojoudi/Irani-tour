...
import ir.sajjad.iranitour.databinding.FragmentKurdistanBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent


class KurdistanFragment : Fragment(), ItemCityEvent {
    lateinit var binding: FragmentKurdistanBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentKurdistanBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.baneh),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.bijar),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.dehgolan),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.divandarreh),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.sarvabad),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.qorveh),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.kamyaran),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.marivan),
                "",
                "",
                false
            )
        ...
        binding.recyclerKurdistan.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerKurdistan.setHasFixedSize(true)
        binding.recyclerKurdistan.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerKurdistan.layoutAnimation = controller
