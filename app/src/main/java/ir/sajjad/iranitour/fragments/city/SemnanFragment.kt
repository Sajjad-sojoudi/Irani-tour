...
import ir.sajjad.iranitour.databinding.FragmentSemnanBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent

class SemnanFragment : Fragment(),ItemCityEvent {
    lateinit var binding: FragmentSemnanBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View? {
        binding = FragmentSemnanBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.ardan),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.damghan),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.sorkheh),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.shahrood),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.garmsar),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.mehdishahr),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.maime),
                "",
                "",
                false
            )
        ...
        binding.recyclerSemnan.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerSemnan.setHasFixedSize(true)
        binding.recyclerSemnan.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerSemnan.layoutAnimation = controller
