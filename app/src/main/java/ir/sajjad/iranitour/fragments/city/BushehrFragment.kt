...
import ir.sajjad.iranitour.databinding.FragmentBushehrBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent


class BushehrFragment : Fragment(),ItemCityEvent {
    lateinit var binding: FragmentBushehrBinding
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentBushehrBinding.inflate(layoutInflater)
        return binding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.bushehr),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.tangestan),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.jam),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.dashtestan),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.dashti),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.dayyer),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.deylam),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.asaluyeh),
                "",
                "",
                false
            ),
            ItemPostCity(
                9,
                resources.getString(R.string.kangan),
                "",
                "",
                false
            ),
            ItemPostCity(
                10,
                resources.getString(R.string.ganaveh),
                "",
                "",
                false
            )
        ...
        binding.recyclerBushehr.layoutManager = LinearLayoutManager(context, RecyclerView.VERTICAL,false)
        binding.recyclerBushehr.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerBushehr.layoutAnimation = controller
    }
