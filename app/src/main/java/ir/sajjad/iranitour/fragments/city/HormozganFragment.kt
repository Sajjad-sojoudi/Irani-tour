...
import ir.sajjad.iranitour.databinding.FragmentHormozganBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent


class HormozganFragment : Fragment(), ItemCityEvent {
    lateinit var binding:FragmentHormozganBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentHormozganBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.abu_musa),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.bastak),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.bashagard),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.bandar_lngeh),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.bandar_abbas),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.parsiyan),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.jask),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.hajiabad),
                "",
                "",
                false
            ),
            ItemPostCity(
                9,
                resources.getString(R.string.khamir),
                "",
                "",
                false
            ),
            ItemPostCity(
                10,
                resources.getString(R.string.rudan),
                "",
                "",
                false
            ),
            ItemPostCity(
                11,
                resources.getString(R.string.sirik),
                "",
                "",
                false
            ),
            ItemPostCity(
                12,
                resources.getString(R.string.qeshm),
                "",
                "",
                false
            ),
            ItemPostCity(
                13,
                resources.getString(R.string.minab),
                "",
                "",
                false
            )
        ...
        binding.recyclerHormozgan.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerHormozgan.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerHormozgan.layoutAnimation = controller
    }
