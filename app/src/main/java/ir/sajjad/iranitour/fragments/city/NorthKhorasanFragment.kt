...
import ir.sajjad.iranitour.databinding.FragmentNorthKhorasanBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent

class NorthKhorasanFragment : Fragment(),ItemCityEvent {
    lateinit var binding : FragmentNorthKhorasanBinding
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentNorthKhorasanBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.esfarayen),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.bojnurd),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.jajarm),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.raz_and_jargalan),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.shirvan),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.faruj),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.garmeh),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.maneh_and_samalqan),
                "",
                "",
                false
            )
        ...
        binding.recyclerNorthKhorasan.layoutManager = LinearLayoutManager(context, RecyclerView.VERTICAL,false)
        binding.recyclerNorthKhorasan.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerNorthKhorasan.layoutAnimation = controller
    }
