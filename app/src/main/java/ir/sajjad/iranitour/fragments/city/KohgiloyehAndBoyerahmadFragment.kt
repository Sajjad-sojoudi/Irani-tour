...
import ir.sajjad.iranitour.databinding.FragmentKohgiloyehAndBoyerahmadBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent


class KohgiloyehAndBoyerahmadFragment : Fragment(), ItemCityEvent {
    lateinit var binding: FragmentKohgiloyehAndBoyerahmadBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentKohgiloyehAndBoyerahmadBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.basht),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.boyer_ahmad),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.bahmai),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.choram),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.dena),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.kohgiluyeh),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.gachsaran),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.landeh),
                "",
                "",
                false
            ),
            ItemPostCity(
                9,
                resources.getString(R.string.maregoon),
                "",
                "",
                false
            )
        ...
        binding.recyclerKohgiloyehAndBoyerahmad.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerKohgiloyehAndBoyerahmad.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerKohgiloyehAndBoyerahmad.layoutAnimation = controller
    }
