...
import ir.sajjad.iranitour.databinding.FragmentChaharMahalBakhtiariBinding
import ir.sajjad.iranitour.databinding.ItemImageShowBinding
import ir.sajjad.iranitour.interfaces.ItemCityEvent


class ChaharMahalBakhtiariFragment : Fragment(),ItemCityEvent {
    lateinit var binding: FragmentChaharMahalBakhtiariBinding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentChaharMahalBakhtiariBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<ItemPostCity>(
            ItemPostCity(
                1,
                resources.getString(R.string.ardal),
                "",
                "",
                false
            ),
            ItemPostCity(
                2,
                resources.getString(R.string.borujen),
                "",
                "",
                false
            ),
            ItemPostCity(
                3,
                resources.getString(R.string.ben),
                "",
                "",
                false
            ),
            ItemPostCity(
                4,
                resources.getString(R.string.khanmirza),
                "",
                "",
                false
            ),
            ItemPostCity(
                5,
                resources.getString(R.string.saman),
                "",
                "",
                false
            ),
            ItemPostCity(
                6,
                resources.getString(R.string.shahrekord),
                "",
                "",
                false
            ),
            ItemPostCity(
                7,
                resources.getString(R.string.farsan),
                "",
                "",
                false
            ),
            ItemPostCity(
                8,
                resources.getString(R.string.farokhshahr),
                "",
                "",
                false
            ),
            ItemPostCity(
                9,
                resources.getString(R.string.falard),
                "",
                "",
                false
            ),
            ItemPostCity(
                10,
                resources.getString(R.string.kuhrang),
                "",
                "",
                false
            ),
            ItemPostCity(
                11,
                resources.getString(R.string.kiar),
                "",
                "",
                false
            ),
            ItemPostCity(
                12,
                resources.getString(R.string.lordegan),
                "",
                "",
                false
            )
        ...
        binding.recyclerChaharMahalBakhtiari.layoutManager = LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerChaharMahalBakhtiari.setHasFixedSize(true)
        binding.recyclerChaharMahalBakhtiari.adapter = adaptersCity
        val animation = AnimationUtils.loadAnimation(context, R.anim.item_enter_anim)
        val controller = LayoutAnimationController(animation)
        binding.recyclerChaharMahalBakhtiari.layoutAnimation = controller
